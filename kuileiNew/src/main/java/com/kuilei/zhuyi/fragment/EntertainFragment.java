...
public class EntertainFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,BaseSliderView.OnSliderClickListener {
    private final  Class TAG = EntertainFragment.class;
    ...
    protected void initView() {
        ...
        Logger.w(EntertainFragment.class,"initView");
...
//                loadData(getNewUrl(index + ""));
    ...
    public void getResult(String result) {
        ...
        mSwipeLayout.setRefreshing(false);
        //解析数据
        List<NewModle> list = NewListJson.instance(getActivity()).readJsonNewModles(result, Url.YuLeId);
