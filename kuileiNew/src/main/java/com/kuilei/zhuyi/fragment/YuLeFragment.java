...
public class YuLeFragment extends BaseMainFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void getResult(String result) {
        Logger.w(YuLeFragment.class,"getResult = " + this.getClass().getName());
